...
<table>
  <tr>
    <td width="33.33%" valign="top" align="center">
      <h3>Summo Order</h3>
      <p>Multi-tenant order and inventory platform, built and deployed for a client.</p>
    ...
    <td width="33.33%" valign="top" align="center">
      <h3>Ludex</h3>
      <p>Game review hub with price comparator across Steam, Epic, Nuuvem and GOG.</p>
    ...
    <td width="33.33%" valign="top" align="center">
      <h3>CodeQuest</h3>
      <p>Gamified platform for teaching programming. My final graduation project.</p>
      <a href="https://github.com/mj01px/code-quest" target="_blank">
        <img src="https://img.shields.io/badge/Repository-181717?style=for-the-badge&logo=github&logoColor=white" alt="Repository">
      </a>
    </td>
  </tr>
  <tr>
    <td width="33.33%" valign="top" align="center">
      <h3>Spectrum</h3>
      <p>Lightweight YouTube multi-player for portrait monitors. Split screen, no clutter.</p>
    ...
    <td width="33.33%" valign="top" align="center">
      <h3>MX Studio</h3>
      <p>Scroll-linked video landing page with glassmorphism and AI-generated assets.</p>
    ...
    <td width="33.33%" valign="top" align="center">
      ...
      <p>Diabetes diagnosis from the Pima dataset, with a support vector machine.</p>
